...
//    @JsonIgnore
    ...
    public Employee(Integer id_employee, String name, boolean gender, String phoneNumber, String address, double salary, LocalDateTime dayOfWork, List<Medicine> medicineList, List<Bill> billList) {
