...
import {DoanhThuDay} from "./user/admin/doanh_thu_month/DoanhThuDay";
import {DanhThuMonth} from "./user/employee/doanh_thu_day/DanhThuMonth";
        ...
        <Navbar></Navbar>
          <BrowserRouter>
              <Routes>
                  ...
                  <Route path={"/day/chart"} element={<DoanhThuDay/>}></Route>
                  <Route path={"/month/chart"} element={<DanhThuMonth/>}></Route>
              </Routes>
              <ToastContainer/>
          </BrowserRouter>
      </>
